...
meson_options_help() {
  ...
  printf "%s\n" '  l1-dsp          Calypso: couche 1 DSP C54x (mask-ROM TI reelle)'
  printf "%s\n" '  l1-grgsm        Calypso: couche 1 gr-gsm (demodulation cote hote)'
...
_meson_option_parse() {
  case $1 in
    ...
    --enable-l1-dsp) printf "%s" -Dl1_dsp=enabled ;;
    --disable-l1-dsp) printf "%s" -Dl1_dsp=disabled ;;
    --enable-l1-grgsm) printf "%s" -Dl1_grgsm=enabled ;;
    --disable-l1-grgsm) printf "%s" -Dl1_grgsm=disabled ;;
